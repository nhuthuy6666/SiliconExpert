        ...
        <div class="flex flex-row gap-[24px]">
            <div class="w-full max-w-[406px] flex flex-col gap-[16px]">
                ...
                <div class="flex flex-col gap-[8px]">
                    ...
                    <div class="flex flex-row gap-[16px]">
                        <p class="text-[12px] font-[400]">May 21, 2025</p>
                        ...
                        <div class="flex flex-row gap-[4px] w-[87px] h-[20px]">
                            <div class="w-[16px] h-[16px] flex flex-row items-center justify-center">
                                <img class="w-[13px] h-[13px]" src="<?php echo get_template_directory_uri(); ?>/assets/images/time.svg"/>
                            </div>
                            <p class="text-[12px] font-[400]">4 min read</p>
                        </div>
                    </div>
                </div>
            </div>
