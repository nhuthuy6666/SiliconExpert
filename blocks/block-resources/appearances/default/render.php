...
<div class="se-block-resources">
    <div class="se-block-resources__header">
        <div class="se-block-resources__header-left">
            ...
            <h6 class="se-block-resources__title">Insights and resources</h6>
        </div>
        <a href="#" class="se-block-resources__cta">
            <span class="fill-layout"></span>
            <p class="se-block-resources__cta-text">Secondary CTA</p>
        </a>
    </div>
    <div class="se-block-resources__content">
            ...
            <div class="se-block-resources__image-wrap">
                ...
                <a href="#" class="se-block-resources__image-btn" aria-label="Open resource">
                    <div class="se-block-resources__arrow-container">
                        <img class="se-block-resources__arrow-old" src="<?php echo get_template_directory_uri(); ?>/assets/images/vector.svg" alt="">
                        <img class="se-block-resources__arrow-new" src="<?php echo get_template_directory_uri(); ?>/assets/images/vector.svg" alt="">
                    </div>
                </a>
            </div>
            <div class="se-block-resources__main-meta">
                ...
                <div class="se-block-resources__meta-row">
                    ...
                    <div class="se-block-resources__readtime">
                        <img class="se-block-resources__readtime-icon" src="<?php echo get_template_directory_uri(); ?>/assets/images/time.svg" alt="<?php bloginfo('name'); ?>"/>
        ...
        <div class="se-block-resources__side">
            <?php foreach ( ( is_array( $data->right_blogs ?? null ) ? $data->right_blogs : array() ) as $row ) : ?>
